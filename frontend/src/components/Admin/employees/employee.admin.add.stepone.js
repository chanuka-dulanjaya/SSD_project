                      ...
                      <MDBRow>
                        ...
                        <MDBCol sm='6'>
                            ...
                            <MDBCardBody>
                                 ...
                                 <div class="mb-3">
                                    <label form="exampleFormControlInput1" class="form-label" style={{fontSize:"17px"}}><b>Enter a User Name</b></label>
                                ...
                                <div class="mb-3">
                                    <label form="exampleFormControlInput1" class="form-label" style={{fontSize:"17px"}}><b>Enter a Phone Number</b></label>
                                ...
                                <div class="mb-3">
                                    <label form="exampleFormControlInput1" class="form-label" style={{fontSize:"17px"}}><b>Enter a Password</b></label>
                                ...
                                <div class="mb-3">
                                    <label form="exampleFormControlInput1" class="form-label" style={{fontSize:"17px"}}><b>Re-type Your Password</b></label>
                                ...
                                <div className="mb-3">
                                    <label form="exampleFormControlInput1" class="form-label" style={{fontSize:"17px"}}><b>Enter User Type</b></label>
