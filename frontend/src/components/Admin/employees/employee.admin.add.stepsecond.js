                      ...
                      <MDBRow>
                        ...
                        <MDBCol sm='6'>
                            ...
                            <MDBCardBody>
                                ...
                                <div class="mb-3 mt-4">
                                  <label form="exampleFormControlInput1" class="form-label" style={{fontSize:"18px"}}>Employee User Name</label>
                                ...
                                <div class="mb-3">
                                  <label form="exampleFormControlInput1" class="form-label" style={{fontSize:"18px"}}>Employee Name</label>
                                ...
                                <div class="mb-3">
                                  <label form="exampleFormControlInput1" class="form-label" style={{fontSize:"18px"}}>Address</label>
                                ...
                                <div class="mb-3">
                                  <label form="exampleFormControlInput1" class="form-label" style={{fontSize:"18px"}}>Telephone Number</label>
                                ...
                                <div class="mb-3">
                                  <label form="exampleFormControlInput1" class="form-label" style={{fontSize:"18px"}}>Gender</label>
                                ...
                                <div class="mb-3">
                                  <label form="exampleFormControlInput1" class="form-label" style={{fontSize:"18px"}}>BOD</label>
                                ...
                                <div class="mb-3">
                                  <label form="exampleFormControlInput1" class="form-label" style={{fontSize:"18px"}}>NIC</label>
