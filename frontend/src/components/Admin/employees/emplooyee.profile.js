                  ...
                  <MDBCol sm='6'>
                      ...
                      <MDBCardBody className="pt-5 mt-3 text-left" style={{padding:'10%'}}>
                        ...
                        <div className="bg-light p-4">
                          ...
                          <div class="mb-3 mt-4">
                            <label form="exampleFormControlInput1" class="form-label" style={{fontSize:"20px"}}><b>Employee User Name</b></label>
                          ...
                          <div class="mb-3">
                            <label form="exampleFormControlInput1" class="form-label" style={{fontSize:"20px"}}><b>Enter Employee Name</b></label>
                          ...
                          <div class="mb-3">
                            <label form="exampleFormControlInput1" class="form-label" style={{fontSize:"20px"}}><b>Enter Address</b></label>
                          ...
                          <div class="mb-3">
                            <label form="exampleFormControlInput1" class="form-label" style={{fontSize:"20px"}}><b>Enter Telephone Number</b></label>
                          ...
                          <div class="mb-3">
                            <label form="exampleFormControlInput1" class="form-label" style={{fontSize:"20px"}}><b>Select Gender</b></label>
                          ...
                          <div class="mb-3">
                            <label form="exampleFormControlInput1" class="form-label" style={{fontSize:"20px"}}><b>Enter Birth of date</b></label>
                          ...
                          <div class="mb-3">
                            <label form="exampleFormControlInput1" class="form-label" style={{fontSize:"20px"}}><b>Employee NIC Number</b></label>
