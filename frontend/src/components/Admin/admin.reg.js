                 ...
                 <MDBCol sm='6'>
                    ...
                    <MDBCardBody className="pt-5 mt-3 text-left">
                       <div className="bg-light p-4">
                            ...
                            <div class="mb-3">
                            <label form="exampleFormControlInput1" class="form-label" style={{fontSize:"20px"}}><b>User Name</b></label>
                            ...
                            <div class="mb-3">
                            <label form="exampleFormControlInput1" class="form-label" style={{fontSize:"20px"}}><b>Phone Number</b></label>
                            ...
                            <div class="mb-3">
                            <label form="exampleFormControlInput1" class="form-label" style={{fontSize:"20px"}}><b>Password</b></label>
                            ...
                            <div class="mb-3">
                            <label form="exampleFormControlInput1" class="form-label" style={{fontSize:"20px"}}><b>Retype Password</b></label>
                            <input class="form-control" type={passwordShown ? "text" : "password"} id="pass" style={{fontSize:"18px"}}  onChange={(e) =>{
                            ...
                            <div className="mb-3">
                                    <label form="exampleFormControlInput1" class="form-label" style={{fontSize:"20px"}}><b>User Type</b></label>
