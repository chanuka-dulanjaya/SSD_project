                 ...
                 <MDBCol sm='6'>
                    ...
                    <MDBCardBody className="pt-5 mt-3 text-left">
                       <div className="bg-light p-4">
                        ...
                        <div class="mb-3">
                          <label form="exampleFormControlInput1" class="form-label">Full Name</label>
                        ...
                        <div class="mb-3">
                          <label form="exampleFormControlInput1" class="form-label">Phone Number</label>
                          <NumberFormat format="0## ### ####" class="form-control" value={telephone1} placeholder="071 110 1111"  onChange={(e) =>{
                              setPhone(e.target.value);
                          }} />
                        </div>
                         <div class="mb-3">
                          <label form="exampleFormControlInput1" class="form-label">Email</label>
                          <input type="email" class="form-control" value={email} onChange={(e) =>{
                              setEmail(e.target.value);
                          }} />
                        </div>
                        <div class="mb-3">
                          <label form="exampleFormControlInput1" class="form-label">Address</label>
                        ...
                        <div class="mb-3">
                          <label form="exampleFormControlInput1" class="form-label">Your Favorite Vehicle Category</label>
                        ...
                        <div class="mb-3">
                          <label form="exampleFormControlInput1" class="form-label">Other Categories</label>
                          <input type="text" class="form-control" value={otherCategory} onChange={(e) =>{
                              setOtherCategories(e.target.value);
                          }} />
                        </div>
                         <div class="mb-3">
                          <label form="exampleFormControlInput1" class="form-label">Your Favorite Vehicle Brand</label>
                        ...
                        <div class="mb-3">
                          <label form="exampleFormControlInput1" class="form-label">Other Brands</label>
                          <input type="text" class="form-control" value={otherBrand} onChange={(e) =>{
                              setOtherBrands(e.target.value);
                          }} />
                        </div>
                         <div class="mb-3">
                          <label form="exampleFormControlInput1" class="form-label">Your Average Salary</label>
                         ...
                         <div class="mb-3">
                          <label form="exampleFormControlInput1" class="form-label">Your Dream Vehicle</label>
