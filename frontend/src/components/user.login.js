...
import { MDBBtn, MDBCol, MDBCard, MDBCardImage, MDBRow , MDBCardBody } from 'mdb-react-ui-kit';
                ...
                <MDBCol sm='5'>
                    ...
                    <MDBCardBody className="pt-5 mt-3 text-left">
                       <div className="bg-light p-4">
                        ...
                        <div class="mb-3">
                          <label form="exampleFormControlInput1" class="form-label" style={{fontSize:"18px"}}>User Name</label>
                         <input class="form-control" type="text"  id="pass" placeholder="Enter UserName" style={{fontSize:"18px"}} onChange={(e) =>{
                            setUsername(e.target.value);
                         }}/>
                        </div>
                        <div class="mb-3">
                          <label form="exampleFormControlInput1" class="form-label" style={{fontSize:"18px"}}>Password</label>
